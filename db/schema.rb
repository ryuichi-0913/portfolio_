...
ActiveRecord::Schema.define(version: 2020_10_22_120256) do
  ...
  create_table "nonfood_comments", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "nonfood_favorites", force: :cascade do |t|
    t.integer "user_id"
    t.integer "nonfood_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "nonfoods", force: :cascade do |t|
    t.integer "user_id"
